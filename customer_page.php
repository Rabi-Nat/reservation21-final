...
<body class="home-7">
  ...
  ============================== -->
    ...
    Sidemenu
============================== -->
    <?php include 'assets/includes/costumer-page-sidemenu.php'; ?>
<!--==============================
    Popup Search Box
    ============================== -->
    ...
    Header Area
    ==============================-->
    <?php include 'assets/includes/costumer-page-header.php'; ?>
    <!--==============================
    Hero Area
    ==============================-->
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-6 col-lg-3 col-xl order-0 order-lg-0">
                    <div class="about-avater">
                        ...
                        <h3 class="name h4"><a href="service.html" class="text-inherit">سالن زیبایی آرایشی بانوان </a></h3>
                    </div>
                </div>
                <div class="col-lg-6 order-2 order-lg-1 col-xl-5 text-center">
                    <div class="mb-30">
                        <span class="sec-subtitle mb-4">رزرو سالن زیبایی</span>
                        <h2 class="sec-title"> زیبایی در سطح جهانی</h2>
                ...
                <div class="col-6 col-lg-3 col-xl order-1 order-lg-2">
                    <div class="about-avater">
                        ...
                        <h3 class="name h4"><a href="service.html" class="text-inherit">سالن آرایشی آقایان </a></h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container z-index-common">
            ...
            <div class="video-box-inner bg-white">
                <div class="video-box position-relative mega-hover" style="transform: scale(0.75); margin: auto;">
                    <img src="assets/img/gallery/w1.jpg" alt="Video Thumb" class="w-100">
    ...
    <section class=" space-top space-extra-bottom">
        <div class="container">
            <div class="row gx-60">
                <div class="col-lg-6">
                    <div class="img-box9">
                        <div class="img-1"><img src="assets/img/gallery/w4 (2).JPG" alt="About Image"></div>
  ...
  ==============================-->
        ...
        <div class="container">
            <div class="row  text-center justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-6">
                    <div class="title-area">
                        <span class="sec-subtitle">بلاگ</span>
                        <h2 class="sec-title">اخبار و مقالات روز</h2>
                    </div>
                </div>
            </div>
            <div class="row vs-carousel" data-slide-show="3" data-md-slide-show="2" data-sm-slide-show="2">
                <div class="col-xl-4">
                    <div class="vs-blog blog-style5 image-box-hover">
                        <div class="box-img blog-img">
                            <img src="assets/img/blog/blog-1-1.jpg" alt="Blog Image" class="w-100">
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="blog.html">۲۴ بهمن ۱۳۹۹</a>
                                <span class="category">
                                    <a href="blog.html">عروسی</a>
                                </span>
                            </div>
                            <h3 class="blog-title"><a href="blog-details.html">حذف علف‌های هرز اولیه</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="vs-blog blog-style5 image-box-hover">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="blog.html">۲۱ اردیبهشت ۱۴۰۰</a>
                                <span class="category">
                                    <a href="blog.html">ازدواج</a>
                                </span>
                            </div>
                            <h3 class="blog-title"><a href="blog-details.html">از ریشه‌های قرون وسطایی تا عصر دیجیتال</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="vs-blog blog-style5 image-box-hover">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="blog.html">۱۳ فروردین ۱۴۰۰</a>
                                <span class="category">
                                    <a href="blog.html">ببهو</a>
                                </span>
                            </div>
                            <h3 class="blog-title"><a href="blog-details.html">لورم ایپسوم به عنوان متنی بی‌معنی آغاز شد</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="vs-blog blog-style5 image-box-hover">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="blog.html">۲۸ اسفند ۱۳۹۹</a>
                                <span class="category">
                                    <a href="blog.html">عشق و ازدواج</a>
                                </span>
                            </div>
                            <h3 class="blog-title"><a href="blog-details.html">تایم‌لاین‌های ایجاد لورم ایپسوم</a></h3>
                        </div>
                    </div>
                </div>
            </div>
	...
	******************************** -->
    ...
    <!--==============================
        All Js File
    ============================== -->
    <?php include 'assets/includes/jsfiles.php'; ?>
