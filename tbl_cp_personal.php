...
if (!empty($customer_id)) {
    ...
    WHERE customer_id = ? AND first_name IS NOT NULL AND TRIM(first_name) <> '' LIMIT 1";
...
<?php if ($customer_exist): ?>
    <div class="admin-card" id="tbl_generated_cp_personal">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form method="post" action="cp_config_personal.php" onsubmit="return confirm('آیا مطمئنید می‌خواهید اطلاعات شخصی پاک شود؟');">
