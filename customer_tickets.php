...
$cp_ticket_fileType_error = $_SESSION['cp_ticket_fileType_error'] ?? "";
$cp_ticket_file_error = $_SESSION['cp_ticket_file_error'] ?? "";
$cp_upload_ticket = $_SESSION['cp_upload_ticket'] ?? "";
$cp_upload_ticket_error = $_SESSION['cp_upload_ticket_error'] ?? "";

unset(
    $_SESSION['cp_emptyfield_error'],
    $_SESSION['salon_pic_file_error'],
    $_SESSION['salon_pic_fileSize_error'],
    $_SESSION['cp_ticket_fileType_error'],
    $_SESSION['cp_ticket_file_error'],
    $_SESSION['cp_upload_ticket'],
    $_SESSION['cp_upload_ticket_error']
);
...
<body>
    <div class="container py-4">
        <?php if (!empty($cp_emptyfield_error)): ?>
        ...
        <?php elseif (!empty($cp_ticket_fileType_error)): ?>
            <div class="notification2"><?php echo $cp_ticket_fileType_error; ?></div>
        <?php elseif (!empty($cp_ticket_file_error)): ?>
            <div class="notification2"><?php echo $cp_ticket_file_error; ?></div>
        <?php elseif (!empty($cp_upload_ticket)): ?>
            <div class="notification1"><?php echo $cp_upload_ticket; ?></div>
        <?php elseif (!empty($cp_upload_ticket_error)): ?>
            <div class="notification2"><?php echo $cp_upload_ticket_error; ?></div>
        <?php endif; ?>

        <div class="ticket-container" id="cp_ticket_div">
            <div class="ticket-header">
                <h2>تیکت‌های من</h2>
                <a href="customer_profile.php" class="btn btn-secondary">بازگشت به پنل</a>
            </div>
            <!-- فرم ارسال تیکت جدید -->
            <form action="cp_config_tickets.php" method="post" class="ticket-form" id="newTicketForm" enctype="multipart/form-data">
                <div class="row g-3">
                    <div class="col-md-6">
        ...
        <!-- generated table for user to see submitted data of customer tickets -->
        <?php include("tbl_cp_tickets.php"); ?>
