...
var positionParallax = function (e, t, a, i) {
    ...
    universalParallax = function () {
        this.init = function (e) {
            void 0 === e && (e = {}), (e = { speed: void 0 !== e.speed ? e.speed : 1.5, className: void 0 !== e.className ? e.className : "parallax" });
            for (var t = document.getElementsByClassName(e.className), a = 0; t.length > a; a++) {
                ...
                void 0 !== o &&
                    ((t[a].style.backgroundImage = "url(" + o + ")"),
                    1 === t[a].classList.length && "parallax" === t[a].classList[0] && ((t[a].style.backgroundRepeat = "no-repeat"), (t[a].style.backgroundPosition = "center"), (t[a].style.backgroundSize = "cover")));
            }
            document.addEventListener("readystatechange", function (a) {
                var i, n;
                "complete" === a.target.readyState &&
                    ((i = t),
                    (n = e.speed) < 1 && (n = 1),
                    calculateHeight(i, n),
                    mobile ||
