            ...
            parseDate: function (t, a) {
                ...
                for (r = t.replace(m.separators, "\0").split("\0"), o = 0; o < r.length; o++)
                    switch (((i = r[o]), (s = parseInt(i)), n[o])) {
                        ...
                        case "g":
                        case "h":
                            if (((c = r[(u = -1 < n.indexOf("a") ? n.indexOf("a") : -1 < n.indexOf("A") ? n.indexOf("A") : -1)]), -1 < u))
                                (l = e(c, p.meridiem[0]) ? 0 : e(c, p.meridiem[1]) ? 12 : -1), 1 <= s && s <= 12 && -1 < l ? (D.hour = s + l - 1) : 0 <= s && s <= 23 && (D.hour = s);
                            else {
...
var datetimepickerFactory = function (e) {
    ...
    var t = {
        ...
        i = function () {
            ...
            "function" == typeof DateFormatter && (a = n = new DateFormatter({ dateSettings: e.extend({}, o, s) }));
        },
        s = {
            moment: {
                                  ...
                                  (r = d[0].clientHeight),
                                      ...
                                      1 < u
                                          ...
                                          : (s.show(),
                                            ...
                                            !0 !== a && d.trigger("scroll_element.xdsoft_scroller", [t || Math.abs(parseInt(n.css("marginTop"), 10)) / (o - r)]));
                              }),
                    ...
                    M.id && W.attr("id", M.id),
                        ...
                        C.find(".xdsoft_month,.xdsoft_year").on("touchstart mousedown.xdsoft", function (t) {
                            var a,
                                ...
                                s = r.is(":visible");
                            for (
                                C.find(".xdsoft_select").hide(), w.currentTime && (o = w.currentTime[e(this).hasClass("xdsoft_month") ? "getMonth" : "getFullYear"]()), r[s ? "hide" : "show"](), a = r.find("div.xdsoft_option"), n = 0;
                    ...
                    function E() {
                        ...
                        return (
                            M.startDate
                                ...
                                ? ((a = w.strToDateTime(a)), M.yearOffset && (a = new Date(a.getFullYear() - M.yearOffset, a.getMonth(), a.getDate(), a.getHours(), a.getMinutes(), a.getSeconds(), a.getMilliseconds())))
                                : M.defaultDate && ((a = w.strToDateTime(M.defaultDate)), M.defaultTime && ((e = w.strtotime(M.defaultTime)), a.setHours(e.getHours()), a.setMinutes(e.getMinutes()))),
                    ...
                    function R(n) {
                        ...
                        n.mask && t.off("keydown.xdsoft"),
                            ...
                            "string" === e.type(n.mask) &&
                                (r(n.mask, t.val()) || (t.val(n.mask.replace(/[0-9]/g, "_")), o(t[0], 0)),
                                t.on("paste.xdsoft", function (a) {
                                    ...
                                    return (
                                        ...
                                        (d += i.length),
                                        r(n.mask, s) ? ((this.value = s), o(this, d)) : "" === e.trim(s) ? (this.value = n.mask.replace(/[0-9]/g, "_")) : t.trigger("error_input.xdsoft"),
                                        a.preventDefault(),
                                        !1
                                    );
                                }),
                                t.on("keydown.xdsoft", function (a) {
                                    ...
                                    if ((48 <= d && d <= 57) || (96 <= d && d <= 105) || 8 === d || 46 === d) {
                                        ...
                                        for (l += 8 === d ? 0 : 1; /[^0-9_]/.test(n.mask.substr(l, 1)) && l < n.mask.length && 0 < l; ) l += 8 === d ? 0 : 1;
                    ...
                    C.find(".xdsoft_select")
                        ...
                        .on("touchend mousedown.xdsoft", ".xdsoft_option", function () {
                            if (!this.touchMoved) {
                                ...
                                w && w.currentTime && w.currentTime[e(this).parent().parent().hasClass("xdsoft_monthselect") ? "setMonth" : "setFullYear"](e(this).data("value")),
                                    ...
                                    M.onChangeMonth && e.isFunction(M.onChangeMonth) && M.onChangeMonth.call(W, w.currentTime, W.data("input")),
                                    t !== w.currentTime.getFullYear() && e.isFunction(M.onChangeYear) && M.onChangeYear.call(W, w.currentTime, W.data("input"));
                            }
                        }),
                        (W.getValue = function () {
                        ...
                        (W.setOptions = function (n) {
                            ...
                            (M = e.extend(!0, {}, M, n)),
                                ...
                                M.inline && ((I = !0), W.addClass("xdsoft_inline"), t.after(W).hide()),
                                M.inverseButton && ((M.next = "xdsoft_prev"), (M.prev = "xdsoft_next")),
                                M.datepicker ? F.addClass("active") : F.removeClass("active"),
                                M.timepicker ? Y.addClass("active") : Y.removeClass("active"),
                                M.value && (w.setCurrentTime(M.value), t && t.val && t.val(w.str)),
                                    ...
                                    t.off("blur.xdsoft").on("blur.xdsoft", function () {
                                        if (M.allowBlank && (!e.trim(e(this).val()).length || ("string" == typeof M.mask && e.trim(e(this).val()) === M.mask.replace(/[0-9]/g, "_")))) e(this).val(null), W.data("xdsoft_datetime").empty();
                                            ...
                                            if (t) e(this).val(a.formatDate(t, M.format));
                                                ...
                                                !M.datepicker && M.timepicker && 0 <= n && n < 24 && 0 <= r && r < 60
                                                    ? e(this).val(
                                                          [n, r]
                                                              .map(function (e) {
                                                                  return 9 < e ? e : "0" + e;
                        ...
                        (w = new (function () {
                            ...
                            (t.now = function (e) {
                                var a,
                                    ...
                                    r = new Date();
                                return (
                                    !e && M.defaultDate && ((a = t.strToDateTime(M.defaultDate)), r.setFullYear(a.getFullYear()), r.setMonth(a.getMonth()), r.setDate(a.getDate())),
                                    r.setFullYear(r.getFullYear()),
                                    !e && M.defaultTime && ((n = t.strtotime(M.defaultTime)), r.setHours(n.getHours()), r.setMinutes(n.getMinutes()), r.setSeconds(n.getSeconds()), r.setMilliseconds(n.getMilliseconds())),
                                    r
                                );
                            }),
                                ...
                                (t.nextMonth = function () {
                                    ...
                                    return (
                                        ...
                                        M.onChangeMonth && e.isFunction(M.onChangeMonth) && M.onChangeMonth.call(W, w.currentTime, W.data("input")),
                                        a !== t.currentTime.getFullYear() && e.isFunction(M.onChangeYear) && M.onChangeYear.call(W, w.currentTime, W.data("input")),
                                        W.trigger("xchange.xdsoft"),
                                        n
                                    );
                                }),
                                ...
                                (t.strToDateTime = function (e) {
                                    ...
                                    return e && e instanceof Date && t.isValidDate(e)
                                        ? e
                                        : ((o = /^([+-]{1})(.*)$/.exec(e)) && (o[2] = a.parseDate(o[2], M.formatDate)),
                                          (r = o && o[2] ? ((n = o[2].getTime() - 6e4 * o[2].getTimezoneOffset()), new Date(t.now(!0).getTime() + parseInt(o[1] + "1", 10) * n)) : e ? a.parseDate(e, M.format) : t.now()),
                                ...
                                (t.str = function () {
                                    var e = M.format;
                                    return (
                                        M.yearOffset && (e = (e = e.replace("Y", t.currentTime.getFullYear() + M.yearOffset)).replace("y", String(t.currentTime.getFullYear() + M.yearOffset).substring(2, 4))), a.formatDate(t.currentTime, e)
                                    );
                                }),
                            ...
                            .on("dblclick.xdsoft", function () {
                                ...
                                (n = new Date(n.getFullYear(), n.getMonth(), n.getDate())),
                                    ...
                                    n < (e = new Date(e.getFullYear(), e.getMonth(), e.getDate())) ||
                                        ((a = w.strToDate(M.maxDate)), (a = new Date(a.getFullYear(), a.getMonth(), a.getDate())) < n || (t.val(w.str()), t.trigger("change"), W.trigger("close.xdsoft")));
                            }),
                        ...
                        Y.find(".xdsoft_prev,.xdsoft_next").on("touchend mousedown.xdsoft", function () {
                            ...
                            !(function e(o) {
                                ...
                                t.hasClass(M.next) && s - i - M.timeHeightInTimePicker >= d
                                    ? H.css("marginTop", "-" + (d + M.timeHeightInTimePicker) + "px")
                                    : t.hasClass(M.prev) && 0 <= d - M.timeHeightInTimePicker && H.css("marginTop", "-" + (d - M.timeHeightInTimePicker) + "px"),
                                    A.trigger("scroll_element.xdsoft_scroller", [Math.abs(parseInt(H[0].style.marginTop, 10) / (s - i))]),
                                    (r = 10 < r ? 10 : r - 10),
                        ...
                        W.on("xchange.xdsoft", function (i) {
                            clearTimeout(o),
                                (o = setTimeout(function () {
                                    (void 0 !== w.currentTime && null !== w.currentTime) || (w.currentTime = w.now());
                                    for (
                                        var o, i, s, d, u, l, f, c, m, h, g = "", p = new Date(w.currentTime.getFullYear(), w.currentTime.getMonth(), 1, 12, 0, 0), D = 0, y = w.now(), v = !1, b = !1, k = !1, x = !1, T = [], S = !0, O = "";
                                    ...
                                    for (
                                        g += "</tr></thead>",
                                            g += "<tbody>",
                                            !1 !== M.maxDate && ((v = w.strToDate(M.maxDate)), (v = new Date(v.getFullYear(), v.getMonth(), v.getDate(), 23, 59, 59, 999))),
                                            !1 !== M.minDate && ((b = w.strToDate(M.minDate)), (b = new Date(b.getFullYear(), b.getMonth(), b.getDate()))),
                                            !1 !== M.minDateTime && ((k = w.strToDate(M.minDateTime)), (k = new Date(k.getFullYear(), k.getMonth(), k.getDate(), k.getHours(), k.getMinutes(), k.getSeconds()))),
                                            !1 !== M.maxDateTime && ((x = w.strToDate(M.maxDateTime)), (x = new Date(x.getFullYear(), x.getMonth(), x.getDate(), x.getHours(), x.getMinutes(), x.getSeconds()))),
                                            !1 !== x && (h = 31 * (12 * x.getFullYear() + x.getMonth()) + x.getDate());
                                        D < w.currentTime.countDaysInMonth() || p.getDay() !== M.dayOfWeekStart || w.currentTime.getMonth() === p.getMonth();
                                        ...
                                        (T = []),
                                            ...
                                            (m = ""),
                                            T.push("xdsoft_date"),
                                            (f = M.beforeShowDay && e.isFunction(M.beforeShowDay.call) ? M.beforeShowDay.call(W, p) : null),
                                            M.allowDateRe && "[object RegExp]" === Object.prototype.toString.call(M.allowDateRe) && (M.allowDateRe.test(a.formatDate(p, M.formatDate)) || T.push("xdsoft_disabled")),
                                            M.allowDates && 0 < M.allowDates.length && -1 === M.allowDates.indexOf(a.formatDate(p, M.formatDate)) && T.push("xdsoft_disabled");
                                        var _ = 31 * (12 * p.getFullYear() + p.getMonth()) + p.getDate();
                                        ((!1 !== v && v < p) || (!1 !== k && p < k) || (!1 !== b && p < b) || (!1 !== x && h < _) || (f && !1 === f[0])) && T.push("xdsoft_disabled"),
                                            -1 !== M.disabledDates.indexOf(a.formatDate(p, M.formatDate)) && T.push("xdsoft_disabled"),
                                            -1 !== M.disabledWeekDays.indexOf(s) && T.push("xdsoft_disabled"),
                                            t.is("[disabled]") && T.push("xdsoft_disabled"),
                                            f && "" !== f[1] && T.push(f[1]),
                                            w.currentTime.getMonth() !== j && T.push("xdsoft_other_month"),
                                            (M.defaultSelect || W.data("changed")) && a.formatDate(w.currentTime, M.formatDate) === a.formatDate(p, M.formatDate) && T.push("xdsoft_current"),
                                            a.formatDate(y, M.formatDate) === a.formatDate(p, M.formatDate) && T.push("xdsoft_today"),
                                            (0 !== p.getDay() && 6 !== p.getDay() && -1 === M.weekends.indexOf(a.formatDate(p, M.formatDate))) || T.push("xdsoft_weekend"),
                                            void 0 !== M.highlightedDates[a.formatDate(p, M.formatDate)] &&
                                                ((i = M.highlightedDates[a.formatDate(p, M.formatDate)]), T.push(void 0 === i.style ? "xdsoft_highlighted_default" : i.style), (m = void 0 === i.desc ? "" : i.desc)),
                                            M.beforeShowDay && e.isFunction(M.beforeShowDay) && T.push(M.beforeShowDay(p)),
                                            S && ((g += "<tr>"), (S = !1), M.weeks && (g += "<th>" + l + "</th>")),
                                            (g +=
                                                '<td data-date="' +
                                                d +
                                                '" data-month="' +
                                                ...
                                                d +
                                                "</div></td>"),
                                            p.getDay() === M.dayOfWeekStartPrev && ((g += "</tr>"), (S = !0)),
                                            p.setDate(d + 1);
                                    }
                                    (g += "</tbody></table>"),
                                        P.html(g),
                                    ...
                                    var A = 1440;
                                    if (
                                        (!1 !== M.maxTime && ((Y = w.strtotime(M.maxTime)), (A = 60 * Y.getHours() + Y.getMinutes())),
                                        !1 !== M.minDateTime && ((Y = w.strToDateTime(M.minDateTime)), a.formatDate(w.currentTime, M.formatDate) === a.formatDate(Y, M.formatDate)))
                                    ) {
                                        var j = 60 * Y.getHours() + Y.getMinutes();
                                        F < j && (F = j);
                                    }
                                    if (
                                        (!1 !== M.maxDateTime && ((Y = w.strToDateTime(M.maxDateTime)), a.formatDate(w.currentTime, M.formatDate) === a.formatDate(Y, M.formatDate) && (j = 60 * Y.getHours() + Y.getMinutes()) < A && (A = j)),
                                        (c = function (n, r) {
                                            var o,
                                                i = w.now(),
                                            ...
                                            var d = 60 * n + r;
                                            (t.is("[disabled]") || A <= d || d < F) && T.push("xdsoft_disabled"),
                                                ...
                                                (M.initTime || M.defaultSelect || W.data("changed")) &&
                                                    ...
                                                    ((!s && 59 < M.step) || o.getMinutes() === parseInt(r, 10)) &&
                                                    (M.defaultSelect || W.data("changed") ? T.push("xdsoft_current") : M.initTime && T.push("xdsoft_init_time")),
                                                parseInt(y.getHours(), 10) === parseInt(n, 10) && parseInt(y.getMinutes(), 10) === parseInt(r, 10) && T.push("xdsoft_today"),
                                                (O += '<div class="xdsoft_time ' + T.join(" ") + '" data-hour="' + n + '" data-minute="' + r + '">' + a.formatDate(i, M.formatTime) + "</div>");
                                        }),
                                    ...
                                    for (H.html(O), n = "", D = parseInt(M.yearStart, 10); D <= parseInt(M.yearEnd, 10); D += 1)
                                        n += '<div class="xdsoft_option ' + (w.currentTime.getFullYear() === D ? "xdsoft_current" : "") + '" data-value="' + D + '">' + (D + M.yearOffset) + "</div>";
                                    for (z.children().eq(0).html(n), D = parseInt(M.monthStart, 10), n = ""; D <= parseInt(M.monthEnd, 10); D += 1)
                                        n += '<div class="xdsoft_option ' + (w.currentTime.getMonth() === D ? "xdsoft_current" : "") + '" data-value="' + D + '">' + M.i18n[r].months[D] + "</div>";
                            ...
                            var e, t, a, n;
                            M.timepicker &&
                                (H.find(".xdsoft_current").length ? (e = ".xdsoft_current") : H.find(".xdsoft_init_time").length && (e = ".xdsoft_init_time"),
                                e
                                    ? ((t = A[0].clientHeight), (a = H[0].offsetHeight) - t < (n = H.find(e).index() * M.timeHeightInTimePicker + 1) && (n = a - t), A.trigger("scroll_element.xdsoft_scroller", [parseInt(n, 10) / (a - t)]))
                        ...
                        P.on("touchend click.xdsoft", "td", function (a) {
                            ...
                            r.setDate(1),
                                ...
                                t.val(w.str()),
                                M.onSelectDate && e.isFunction(M.onSelectDate) && M.onSelectDate.call(W, w.currentTime, W.data("input"), a),
                                W.data("changed", !0),
                                W.trigger("xchange.xdsoft"),
                                W.trigger("changedatetime.xdsoft"),
                                (1 < i || !0 === M.closeOnDateSelect || (!1 === M.closeOnDateSelect && !M.timepicker)) && !M.inline && W.trigger("close.xdsoft"),
                                setTimeout(function () {
                                    i = 0;
                                }, 200);
                        }),
                            ...
                            .on("touchend click.xdsoft", "div", function (t) {
                                if (!this.touchMoved) {
                                    ...
                                    n.setHours(a.data("hour")),
                                        ...
                                        M.onSelectTime && e.isFunction(M.onSelectTime) && M.onSelectTime.call(W, w.currentTime, W.data("input"), t),
                                        W.data("changed", !0),
                                        W.trigger("xchange.xdsoft"),
                                        W.trigger("changedatetime.xdsoft"),
                                        !0 !== M.inline && !0 === M.closeOnTimeSelect && W.trigger("close.xdsoft");
                                }
                            }),
                        ...
                        t.on("mousewheel.xdsoft", function (e) {
                            return (
                                ...
                                (!M.datepicker && M.timepicker
                                    ? (0 <= (s = H.find(".xdsoft_current").length ? H.find(".xdsoft_current").eq(0).index() : 0) + e.deltaY && s + e.deltaY < H.children().length && (s += e.deltaY),
                                      H.children().eq(s).length && H.children().eq(s).trigger("mousedown"),
                                      !1)
                                    : M.datepicker && !M.timepicker
                                    ? (F.trigger(e, [e.deltaY, e.deltaX, e.deltaY]), t.val && t.val(w.str()), W.trigger("changedatetime.xdsoft"), !1)
                                    : void 0)
                            );
                        }),
                        ...
                        (d = function () {
                            ...
                            "rtl" === d.parent().css("direction") && (r -= W.outerWidth() - d.outerWidth()),
                                M.fixed
                                    ? ((n -= m), (r -= e(M.contentWindow).scrollLeft()), (o = "fixed"))
                                    : ((s = !1),
                                      O(a, function (e) {
                                          return null !== e && ("fixed" === M.contentWindow.getComputedStyle(e).getPropertyValue("position") ? !(s = !0) : void 0);
                                      }),
                                      s && !M.insideParent ? ((o = "fixed"), n + W.outerHeight() > c + m ? ((l = "bottom"), (n = c + m - t.top)) : (n -= m)) : n + W[0].offsetHeight > c + m && (n = t.top - W[0].offsetHeight + 1),
                                      n < 0 && (n = 0),
                                ...
                                (f = { position: o, left: M.insideParent ? a.offsetLeft : r, top: "", bottom: "" }),
                                M.insideParent ? (f[l] = a.offsetTop + a.offsetHeight) : (f[l] = n),
                                W.css(f);
                        }),
                        W.on("open.xdsoft", function (t) {
                            var a = !0;
                            M.onShow && e.isFunction(M.onShow) && (a = M.onShow.call(W, w.currentTime, W.data("input"), t)),
                                !1 !== a &&
                                    (W.show(),
                                    d(),
                                    e(M.contentWindow).off("resize.xdsoft", d).on("resize.xdsoft", d),
                                    M.closeOnWithoutClick &&
                                        e([M.ownerDocument.body, M.contentWindow]).on("touchstart mousedown.xdsoft", function t() {
                            ...
                            .on("close.xdsoft", function (t) {
                                ...
                                C.find(".xdsoft_month,.xdsoft_year").find(".xdsoft_select").hide(),
                                    M.onClose && e.isFunction(M.onClose) && (a = M.onClose.call(W, w.currentTime, W.data("input"), t)),
                        ...
                        t
                            ...
                            .on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", function () {
                                t.is(":disabled") ||
                                    (t.data("xdsoft_datetimepicker").is(":visible") && M.closeOnInputClick) ||
                                    (M.openOnFocus &&
                                        (clearTimeout(N),
                            ...
                            .on("keydown.xdsoft", function (t) {
                                ...
                                return -1 !== [f].indexOf(n) && M.enterLikeTab
                                    ? ((a = e("input:visible,textarea:visible,button:visible,a:visible")), W.trigger("close.xdsoft"), a.eq(a.index(this) + 1).focus(), !1)
                                    : -1 !== [D].indexOf(n)
