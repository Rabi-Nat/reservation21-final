...
var _initLayerSlider = function (i, t, e) {
    ...
    r(document).ready(function () {
        void 0 === r.fn.layerSlider
            ? window._layerSlider && window._layerSlider.showNotice && window._layerSlider.showNotice(i, "jquery")
            : (e &&
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
            ...
            (a = (h = t[v]).a),
                ...
                (f = n
                    ? ((d = T[s]),
                      ...
                      o - ((u = o - (o - a) * (r ? 0.5 * e : 0 !== d ? g / d : 0)) + ((((_ = o + (l - o) * (r ? 0.5 * e : 0 !== m ? g / m : 0)) - u) * ((3 * d) / (d + m) + 0.5)) / 4 || 0)))
                    : o - ((u = o - (o - a) * e * 0.5) + (_ = o + (l - o) * e * 0.5)) / 2),
                (u += f),
                (_ += f),
                (h.c = c = u),
                ...
                (h.ca = c - a),
                (h.ba = x - a),
                i ? ((p = S(a, x, c, o)), t.splice(v, 1, p[0], p[1], p[2], p[3]), (v += 4)) : v++,
                (x = _);
        ((h = t[v]).b = x), (h.c = x + 0.4 * (h.d - x)), (h.da = h.d - h.a), (h.ca = h.c - h.a), (h.ba = x - h.a), i && ((p = S(h.a, x, h.c, h.d)), t.splice(v, 1, p[0], p[1], p[2], p[3]));
    }
    function x(t, e, i, r) {
        var n,
            s,
    ...
    _gsScope._gsDefine(
            ...
            function g(t) {
                ...
                return function (t, e, i) {
                    ...
                    if (!c) {
                        ...
                        for (c = y[f] = [], r = v ? Math.min(_, f) * T - 0.5 : m % _, n = v ? (f * T) / _ - 0.5 : (m / _) | 0, u = 1 / (h = 0), l = 0; l < f; l++)
                            (s = (l % _) - r), (a = n - ((l / _) | 0)), (c[l] = o = x ? Math.abs("y" === x ? a : s) : Math.sqrt(s * s + a * a)), h < o && (h = o), o < u && (u = o);
            ...
            (y.version = "2.1.3"),
                ...
                (t.updateTo = function (t, e) {
                    ...
                    if (r._initted || s)
                        ...
                        else if ((r._gc && r._enabled(!0, !1), r._notifyPluginsOfEnabled && r._firstPT && v._onPluginEvent("_onDisable", r), 0.998 < r._time / r._duration)) {
                            var a = r._totalTime;
                ...
                (t.render = function (t, e, i) {
                    ...
                    if (
                        (c - x <= t && 0 <= t
                            ? ((f._totalTime = c),
                              (f._cycle = f._repeat),
                              f._yoyo && 0 != (1 & f._cycle) ? ((f._time = 0), (f.ratio = f._ease._calcEnd ? f._ease.getRatio(0) : 0)) : ((f._time = g), (f.ratio = f._ease._calcEnd ? f._ease.getRatio(1) : 1)),
                              f._reversed || ((r = !0), (n = "onComplete"), (i = i || f._timeline.autoRemoveChildren)),
                              0 !== g ||
                                  (!f._initted && f.vars.lazy && !i) ||
                                  (f._startTime === f._timeline._duration && (t = 0),
                                  (y < 0 || (t <= 0 && -x <= t) || (y === x && "isPause" !== f.data)) && y !== t && ((i = !0), x < y && (n = "onReverseComplete")),
                                  (f._rawPrevTime = u = !e || t || y === t ? t : x)))
                            : t < x
                            ? ((f._totalTime = f._time = f._cycle = 0),
                              (f.ratio = f._ease._calcEnd ? f._ease.getRatio(0) : 0),
                              (0 !== d || (0 === g && 0 < y)) && ((n = "onReverseComplete"), (r = f._reversed)),
                              -x < t ? (t = 0) : t < 0 && ((f._active = !1), 0 !== g || (!f._initted && f.vars.lazy && !i) || (0 <= y && (i = !0), (f._rawPrevTime = u = !e || t || y === t ? t : x))),
                              f._initted || (i = !0))
                            : ((f._totalTime = f._time = t),
                              0 !== f._repeat &&
                                  ((a = g + f._repeatDelay),
                                  (f._cycle = (f._totalTime / a) >> 0),
                                  0 !== f._cycle && f._cycle === f._totalTime / a && d <= t && f._cycle--,
                                  ...
                                  f._yoyo &&
                                      ...
                                      (_ = f._yoyoEase || f.vars.yoyoEase) &&
                                          (f._yoyoEase ||
                                              (!0 !== _ || f._initted
                                                  ? (f._yoyoEase = _ = !0 === _ ? f._ease : _ instanceof Ease ? _ : Ease.map[_])
                                                  : ((_ = f.vars.ease), (f._yoyoEase = _ = _ ? (_ instanceof Ease ? _ : "function" == typeof _ ? new Ease(_, f.vars.easeParams) : Ease.map[_] || v.defaultEase) : v.defaultEase))),
                                          (f.ratio = _ ? 1 - _.getRatio((g - f._time) / g) : 0))),
                                  f._time > g ? (f._time = g) : f._time < 0 && (f._time = 0)),
                              f._easeType && !_
                                  ? ((o = f._time / g),
                                    (1 === (l = f._easeType) || (3 === l && 0.5 <= o)) && (o = 1 - o),
                                    3 === l && (o *= 2),
                                    1 === (h = f._easePower) ? (o *= o) : 2 === h ? (o *= o * o) : 3 === h ? (o *= o * o * o) : 4 === h && (o *= o * o * o * o),
                                    (f.ratio = 1 === l ? 1 - o : 2 === l ? o : f._time / g < 0.5 ? o / 2 : 1 - o / 2))
                        ...
                        if (!f._initted) {
                            ...
                            if (!i && f._firstPT && ((!1 !== f.vars.lazy && f._duration) || (f.vars.lazy && !f._duration)))
                                return (f._time = p), (f._totalTime = d), (f._rawPrevTime = y), (f._cycle = m), T.lazyTweens.push(f), void (f._lazy = [t, e]);
                        ...
                        for (
                            !1 !== f._lazy && (f._lazy = !1),
                                ...
                                0 === d &&
                                    (2 === f._initted && 0 < t && f._init(), f._startAt && (0 <= t ? f._startAt.render(t, !0, i) : (n = n || "_dummyGS")), !f.vars.onStart || (0 === f._totalTime && 0 !== g) || e || f._callback("onStart")),
                                s = f._firstPT;
                            s;

                        )
                            s.f ? s.t[s.p](s.c * f.ratio + s.s) : (s.t[s.p] = s.c * f.ratio + s.s), (s = s._next);
                        f._onUpdate && (t < 0 && f._startAt && f._startTime && f._startAt.render(t, !0, i), e || (f._totalTime === d && !n) || f._callback("onUpdate")),
                            f._cycle !== m && (e || f._gc || (f.vars.onRepeat && f._callback("onRepeat"))),
                            !n ||
                                (f._gc && !i) ||
                                (t < 0 && f._startAt && !f._onUpdate && f._startTime && f._startAt.render(t, !0, i),
                                r && (f._timeline.autoRemoveChildren && f._enabled(!1, !1), (f._active = !1)),
                                !e && f.vars[n] && f._callback(n),
                                0 === g && f._rawPrevTime === x && u !== x && (f._rawPrevTime = 0));
                ...
                (y.delayedCall = function (t, e, i, r, n) {
                    return new y(e, 0, { delay: t, onComplete: e, onCompleteParams: i, callbackScope: r, onReverseComplete: e, onReverseCompleteParams: i, immediateRender: !1, useFrames: n, overwrite: 0 });
                }),
                (y.set = function (t, e) {
                    return new y(t, 0, e);
                }),
                ...
                (y.killChildTweensOf = function (t, e) {
                    if (null != t) {
                        var i,
                            ...
                            a,
                            o = T.tweenLookup;
                        if (("string" == typeof t && (t = v.selector(t) || t), w(t) && (t = d(t)), b(t))) for (s = t.length; -1 < --s; ) y.killChildTweensOf(t[s], e);
                        else {
            ...
            function (_, f, p) {
                function d(t) {
                    ...
                    var e,
                        ...
                        r = this,
                        n = r.vars;
                    for (i in ((r._labels = {}), (r.autoRemoveChildren = !!n.autoRemoveChildren), (r.smoothChildTiming = !!n.smoothChildTiming), (r._sortChildren = !0), (r._onUpdate = n.onUpdate), n))
                        (e = n[i]), c(e) && -1 !== e.join("").indexOf("{self}") && (n[i] = r._swapSelfInParams(e));
                ...
                return (
                    ...
                    (i.staggerTo = function (t, e, i, r, n, s, a, o) {
                        var l,
                            h,
                            u = new d({ onComplete: s, onCompleteParams: a, callbackScope: o, smoothChildTiming: this.smoothChildTiming }),
                            _ = y(i.stagger || r),
                            f = i.startAt,
                            c = i.cycle;
                        for (
                            ...
                            (l = m(i)), f && ((l.startAt = m(f)), f.cycle && g(l.startAt, t, h)), c && (g(l, t, h), null != l.duration && ((e = l.duration), delete l.duration)), u.to(t[h], e, l, _(h, t[h], t));
                        return this.add(u, n);
                    }),
                    ...
                    (d.exportRoot = function (t, e) {
                        ...
                        for (null == e && (e = !0), o._remove(a, !0), a._startTime = 0, a._rawPrevTime = a._time = a._totalTime = o._time, n = o._first; n; )
                            (s = n._next), (e && n instanceof p && n.target === n.vars.onComplete) || ((r = n._startTime - n._delay) < 0 && (i = 1), a.add(n, r)), (n = s);
                    ...
                    (i.add = function (t, e, i, r) {
                        ...
                        if (("number" != typeof e && (e = u._parseTimeOrLabel(e, 0, !0, t)), !(t instanceof _))) {
                            if (t instanceof Array || (t && t.push && c(t))) {
                                for (i = i || "normal", r = r || 0, n = e, s = t.length, a = 0; a < s; a++)
                        ...
                        if (
                            ...
                            (t._time || (!t._duration && t._initted)) &&
                                ((n = (u.rawTime() - t._startTime) * t._timeScale), (!t._duration || 1e-5 < Math.abs(Math.max(0, Math.min(t.totalDuration(), n))) - t._totalTime) && t.render(n, !1, !1)),
                    ...
                    (i._parseTimeOrLabel = function (t, e, i, r) {
                        ...
                        else if (r && (r instanceof Array || (r.push && c(r)))) for (s = r.length; -1 < --s; ) r[s] instanceof _ && r[s].timeline === this && this.remove(r[s]);
                        if (((n = "number" != typeof t || e ? (99999999999 < this.duration() ? this.recent().endTime(!1) : this._duration) : 0), "string" == typeof e))
                    ...
                    (i.render = function (t, e, i) {
                        ...
                        if ((f !== _._time && (t += _._time - f), _._hasPause && !_._forcingPlayhead && !e)) {
                            if (f < t) for (r = _._first; r && r._startTime <= t && !l; ) r._duration || "isPause" !== r.data || r.ratio || (0 === r._startTime && 0 === _._rawPrevTime) || (l = r), (r = r._next);
                            else for (r = _._last; r && r._startTime >= t && !l; ) r._duration || ("isPause" === r.data && 0 < r._rawPrevTime && (l = r)), (r = r._prev);
                        ...
                        if (c - v <= t && 0 <= t)
                            (_._totalTime = _._time = c),
                                _._reversed ||
                                    ...
                                    0 === _._duration && ((t <= 0 && -v <= t) || _._rawPrevTime < 0 || _._rawPrevTime === v) && _._rawPrevTime !== t && _._first && ((o = !0), _._rawPrevTime > v && (a = "onReverseComplete"))),
                                (_._rawPrevTime = _._duration || !e || t || _._rawPrevTime === t ? t : v),
                                (t = c + 1e-4);
                        else if (t < v)
                            if (
                                ((_._totalTime = _._time = 0),
                                -v < t && (t = 0),
                                (0 !== f || (0 === _._duration && _._rawPrevTime !== v && (0 < _._rawPrevTime || (t < 0 && 0 <= _._rawPrevTime)))) && ((a = "onReverseComplete"), (n = _._reversed)),
                                t < 0)
                            )
                                (_._active = !1), _._timeline.autoRemoveChildren && _._reversed ? ((o = n = !0), (a = "onReverseComplete")) : 0 <= _._rawPrevTime && _._first && (o = !0), (_._rawPrevTime = t);
                            else {
                        ...
                        if ((_._time !== f && _._first) || i || o || l) {
                            if (
                                ...
                                _._active || (!_._paused && _._time !== f && 0 < t && (_._active = !0)),
                                0 === f && _.vars.onStart && ((0 === _._time && _._duration) || e || _._callback("onStart")),
                                f <= (h = _._time))
                            )
                                for (r = _._first; r && ((s = r._next), h === _._time && (!_._paused || m)); )
                            ...
                            _._onUpdate && (e || (T.length && w(), _._callback("onUpdate"))),
                                a &&
                                    (_._gc ||
                                        ...
                                        (n && (T.length && w(), _._timeline.autoRemoveChildren && _._enabled(!1, !1), (_._active = !1)), !e && _.vars[a] && _._callback(a)));
                        }
                    }),
                    ...
                    (i.getChildren = function (t, e, i, r) {
                        ...
                        for (var n = [], s = this._first, a = 0; s; )
                            s._startTime < r || (s instanceof p ? !1 !== e && (n[a++] = s) : (!1 !== i && (n[a++] = s), !1 !== t && (a = (n = n.concat(s.getChildren(!0, e, i))).length))), (s = s._next);
                        return n;
                    }),
                ...
                return (
                    ...
                    (n.removeCallback = function (t, e) {
                        if (t)
                            ...
                            else for (var i = this.getTweensOf(t, !1), r = i.length, n = this._parseTimeOrLabel(e); -1 < --r; ) i[r]._startTime === n && i[r]._enabled(!1, !1);
                        return this;
                    }),
                    ...
                    (n.tweenTo = function (t, e) {
                        ...
                        var i,
                            r,
                            n,
                            s = { ease: h, useFrames: this.usesFrames(), immediateRender: !1, lazy: !1 },
                    ...
                    (n.render = function (t, e, i) {
                        ...
                        if ((c !== f._time && (t += f._time - c), p - C <= t && 0 <= t))
                            f._locked || ((f._totalTime = p), (f._cycle = f._repeat)),
                                f._reversed ||
                                    ...
                                    0 === f._duration && ((t <= 0 && -C <= t) || v < 0 || v === C) && v !== t && f._first && ((o = !0), C < v && (a = "onReverseComplete"))),
                            ...
                            if (
                                ...
                                (f._time = 0),
                                -C < t && (t = 0),
                                (0 !== c || (0 === d && v !== C && (0 < v || (t < 0 && 0 <= v)) && !f._locked)) && ((a = "onReverseComplete"), (n = f._reversed)),
                                t < 0)
                            )
                                (f._active = !1), f._timeline.autoRemoveChildren && f._reversed ? ((o = n = !0), (a = "onReverseComplete")) : 0 <= v && f._first && (o = !0), (f._rawPrevTime = t);
                            else {
                            ...
                            0 === d && v < 0 && (o = !0),
                                ...
                                f._locked ||
                                    ...
                                    0 !== f._repeat &&
                                        ...
                                        f._cycle && f._cycle === f._totalTime / l && m <= t && f._cycle--,
                        ...
                        if (f._hasPause && !f._forcingPlayhead && !e) {
                            ...
                            else for (r = f._last; r && r._startTime >= t && !h; ) r._duration || ("isPause" === r.data && 0 < r._rawPrevTime && (h = r)), (r = r._prev);
                            h &&
                                ((_ = f._startTime + (f._reversed ? f._duration - h._startTime : h._startTime) / f._timeScale),
                                h._startTime < d && ((f._time = f._rawPrevTime = t = h._startTime), (f._totalTime = t + f._cycle * (f._totalDuration + f._repeatDelay))));
                        }
                        if (f._cycle !== T && !f._locked) {
                            ...
                            if (
                                ...
                                (c = w ? 0 : d),
                                f.render(c, e, 0 === d),
                                e || f._gc || (f.vars.onRepeat && ((f._cycle = S), (f._locked = !1), f._callback("onRepeat"))),
                                c !== f._time)
                            )
                                return;
                        ...
                        if ((f._time !== c && f._first) || i || o || h) {
                            if (
                                ...
                                f._active || (!f._paused && f._totalTime !== m && 0 < t && (f._active = !0)),
                                0 === m && f.vars.onStart && ((0 === f._totalTime && f._totalDuration) || e || f._callback("onStart")),
                                c <= (u = f._time))
                            )
                                for (r = f._first; r && ((s = r._next), u === f._time && (!f._paused || x)); )
                                    (r._active || (r._startTime <= f._time && !r._paused && !r._gc)) &&
                            ...
                            f._onUpdate && (e || (R.length && A(), f._callback("onUpdate"))),
                                a &&
                                    (f._locked ||
                                        ...
                                        (n && (R.length && A(), f._timeline.autoRemoveChildren && f._enabled(!1, !1), (f._active = !1)), !e && f.vars[a] && f._callback(a)));
        ...
        (m = _gsScope._gsDefine.plugin({
                ...
                if (
                    ((this._beziers =
                        "cubic" !== e.type && "quadratic" !== e.type && "soft" !== e.type
                            ? c(l, isNaN(e.curviness) ? 1 : e.curviness, !1, "thruBasic" === e.type, e.correlate, o)
                            : (function (t, e, i) {
                                  var r,
                                      n,
                                      s,
                                  ...
                                  for (l = g.length; -1 < --l; ) {
                                      for (p[(_ = g[l])] = o = [], f = 0, u = t.length, h = 0; h < u; h++)
                                          (r = null == i ? t[h][_] : "string" == typeof (c = t[h][_]) && "=" === c.charAt(1) ? i[_] + Number(c.charAt(0) + c.substr(2)) : Number(c)),
                                              m && 1 < h && h < u - 1 && (o[f++] = (r + o[f - 2]) / 2),
                                              (o[f++] = r);
                                      for (u = f - d + 1, h = f = 0; h < u; h += d)
                                          (r = o[h]), (n = o[h + 1]), (s = o[h + 2]), (a = 2 == d ? 0 : o[h + 3]), (o[f++] = c = 3 == d ? new y(r, n, s, a) : new y(r, (2 * n + r) / 3, (2 * n + s) / 3, s));
                                      o.length = f;
                                  }
                                  return p;
                              })(l, e.type, h)),
            ...
            set: function (t) {
                ...
                for (i = 1 - a, r = this._props.length; -1 < --r; )
                    (n = this._props[r]), (o = (a * a * (s = this._beziers[n][e]).da + 3 * i * (a * s.ca + i * s.ba)) * a + s.a), this._mod[n] && (o = this._mod[n](o, p)), c[n] ? p[n](o) : (p[n] = o);
                if (this._autoRotate) {
                    var m,
                        g,
                        y,
                    ...
                    for (r = b.length; -1 < --r; )
                        (n = b[r][2]),
                            ...
                            s &&
                                ...
                                (x += (m.c + (m.d - m.c) * a - x) * a),
                                (o = d ? Math.atan2(x - y, v - g) * w + T : this._initialRotations[r]),
                    ...
                    parser: function (t, e, i, r, n, s) {
                        ...
                        return (
                            ...
                            !f.autoRotate ||
                                ...
                                ((a = !0 === f.autoRotate ? 0 : Number(f.autoRotate)), (f.autoRotate = null != l.end.left ? [["left", "top", "rotation", a, !1]] : null != l.end.x && [["x", "y", "rotation", a, !1]])),
                            f.autoRotate && (r._transform || r._enableTransforms(!1), (l.autoRotate = r._target._gsTransform), (l.proxy.rotation = l.autoRotate.rotation || 0), r._overwriteProps.push("rotation")),
        ...
        _gsScope._gsDefine(
            ...
            function (s, X) {
                ...
                ((t.constructor = B).version = "2.1.3"),
                    ...
                    (t = "px"),
                    (B.suffixMap = { top: t, right: t, bottom: t, left: t, width: t, height: t, fontSize: t, padding: t, margin: t, perspective: t, lineHeight: "" });
                function a(t, e) {
                ...
                function v(t, e) {
                    var i,
                        ...
                        s = {};
                    if ((e = e || y(t)))
                        if ((i = e.length)) for (; -1 < --i; ) (-1 !== (n = e[i]).indexOf("-transform") && Xt !== n) || (s[n.replace(V, a)] = e.getPropertyValue(n));
                        else for (i in e) (-1 !== i.indexOf("Transform") && jt !== i) || (s[i] = e[i]);
                    else if ((e = t.currentStyle || t.style)) for (i in e) "string" == typeof i && void 0 === s[i] && (s[i.replace(V, a)] = e[i]);
                    return (
                        ot || (s.opacity = l(t)),
                        (r = $t(t, e, !1)),
                ...
                function x(t, e, i, r, n) {
                    ...
                    for (a in i)
                        "cssText" !== a &&
                            ...
                            ((l[a] = "auto" !== s || ("left" !== a && "top" !== a) ? (("" !== s && "auto" !== s && "none" !== s) || "string" != typeof e[a] || "" === e[a].replace(u, "") ? s : 0) : ct(t, a)),
                    ...
                    return (
                        ...
                        (o =
                            null == t
                                ...
                                : ((n = 360),
                                  (s = t.split("_")),
                                  (a = ((l = "=" === t.charAt(1)) ? parseInt(t.charAt(0) + "1", 10) * parseFloat(s[0].substr(2)) : parseFloat(s[0])) * (-1 === t.indexOf("rad") ? 1 : J) - (l ? 0 : e)),
                                  s.length &&
                                      (r && (r[i] = e + a),
                                      -1 !== t.indexOf("short") && (a %= n) !== a % 180 && (a = a < 0 ? a + n : a - n),
                                      -1 !== t.indexOf("_cw") && a < 0 ? (a = ((a + 3599999999640) % n) - ((a / n) | 0) * n) : -1 !== t.indexOf("ccw") && 0 < a && (a = ((a - 3599999999640) % n) - ((a / n) | 0) * n)),
                                  e + a)) < 1e-6 &&
                            -1e-6 < o &&
                            (o = 0),
                        o
                ...
                var A,
                    ...
                    ot =
                        ...
                        (i = o("a")),
                        (b = -1 !== at.indexOf("Safari") && -1 === at.indexOf("Chrome") && (-1 === e || 3 < parseFloat(at.substr(e + 8, 2)))),
                        (M = b && parseFloat(at.substr(at.indexOf("Version/") + 8, 2)) < 6),
                        (Y = -1 !== at.indexOf("Firefox")),
                        (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(at) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(at)) && (D = parseFloat(RegExp.$1)),
                    ...
                    _t = (B.getStyle = function (t, e, i, r, n) {
                        var s;
                        return ot || "opacity" !== e
                            ? (!r && t.style[e] ? (s = t.style[e]) : (i = i || y(t)) ? (s = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(f, "-$1").toLowerCase())) : t.currentStyle && (s = t.currentStyle[e]),
                    ...
                    ft = (st.convertToPixels = function (t, e, i, r, n) {
                        ...
                        if ((_ && (i = -i), f && (i *= 100), "lineHeight" !== e || r))
                            if ("%" === r && -1 !== e.indexOf("border")) s = (i / 100) * (l ? t.clientWidth : t.clientHeight);
                                ...
                                if (((u.cssText = "border:0 solid red;position:" + _t(t, "position") + ";line-height:0;"), "%" !== r && h.appendChild && "v" !== r.charAt(0) && "rem" !== r))
                                ...
                                h.appendChild(rt),
                                    ...
                                    h.removeChild(rt),
                                    l && "%" === r && !1 !== B.cacheWidths && (((a = h._gsCache = h._gsCache || {}).time = o), (a.width = (s / i) * 100)),
                    ...
                    yt = (B.parseColor = function (t, e) {
                        ...
                        return (
                            e &&
                                ...
                                h === u ? (a = o = 0) : ((_ = h - u), (o = 0.5 < l ? _ / (2 - h - u) : _ / (h + u)), (a = h === r ? (n - s) / _ + (n < s ? 6 : 0) : h === n ? (s - r) / _ + 2 : (r - n) / _ + 4), (a *= 60)),
                                (i[0] = (a + 0.5) | 0),
                                (i[1] = (100 * o + 0.5) | 0),
                                (i[2] = (100 * l + 0.5) | 0)),
                            i
                ...
                var bt =
                    ...
                    St = (B.parseComplex = function (t, e, i, r, n, s, a, o, l, h) {
                        (i = i || s || ""),
                            ...
                            (r += ""),
                            n && vt.test(r + i) && ((r = [i, r]), B.colorStringFilter(r), (i = r[0]), (r = r[1]));
                        var u,
                            _,
                            f,
                            c,
                            ...
                            (-1 === r.indexOf(",") && -1 === i.indexOf(",")) ||
                                ((P =
                                    -1 !== (r + i).indexOf("rgb") || -1 !== (r + i).indexOf("hsl")
                                        ? ((b = b.join(" ").replace(Z, ", ").split(" ")), P.join(" ").replace(Z, ", ").split(" "))
                                        : ((b = b.join(" ").split(",").join(", ").split(" ")), P.join(" ").split(",").join(", ").split(" "))),
                                (S = b.length)),
                                ...
                                (T = ")" + ((T = p.indexOf(")") + 1) ? p.substr(T) : "")),
                                    ...
                                    (y = 6 < c.length + p.length) && !ot && 0 === p[3]
                                        ...
                                        : (ot || (y = !1),
                                          w
                                              ? a
                                                    .appendXtra(v.substr(0, v.indexOf("hsl")) + (y ? "hsla(" : "hsl("), c[0], k(p[0], c[0]), ",", !1, !0)
                                                    .appendXtra("", c[1], k(p[1], c[1]), "%,", !1)
                                                    .appendXtra("", c[2], k(p[2], c[2]), y ? "%," : "%" + T, !1)
                                              : a
                                                    .appendXtra(v.substr(0, v.indexOf("rgb")) + (y ? "rgba(" : "rgb("), c[0], p[0] - c[0], ",", Math.round, !0)
                                                    .appendXtra("", c[1], p[1] - c[1], ",", Math.round)
                                                    .appendXtra("", c[2], p[2] - c[2], y ? "," : T, Math.round),
                                          y && ((c = c.length < 4 ? 1 : c[3]), a.appendXtra("", c, (p.length < 4 ? 1 : p[3]) - c, T, !1))),
                                    (vt.lastIndex = 0);
                            else if ((d = c.match(z))) {
                                if (!(m = p.match(E)) || m.length !== d.length) return a;
                                for (_ = f = 0; _ < d.length; _++)
                                    (x = d[_]), (v = c.indexOf(x, f)), a.appendXtra(c.substr(f, v - f), Number(x), k(m[_], x), "", O && "px" === c.substr(v + x.length, 2) && Math.round, 0 === _), (f = v + x.length);
                                a["xs" + a.l] += c.substr(f);
                        ...
                        return (
                            ...
                            i || 0 === o || a.plugin
                                ? (a.l++,
                                  ...
                                  (a["xs" + a.l] = r || ""),
                                  0 < o
                                      ? ((a.data["xn" + o] = e + i), (a.rxp["xn" + o] = n), (a["xn" + o] = e), a.plugin || ((a.xfirst = new Pt(a, "xn" + o, e, i, a.xfirst || a, 0, a.n, n, a.pr)), (a.xfirst.xs0 = 0)))
                                      : ((a.data = { s: e + i }), (a.rxp = {}), (a.s = e), (a.c = i), (a.r = n)))
                                : (a["xs" + o] += e + (r || "")),
                            a
                        );
                    });
                function kt(t, e) {
                    (e = e || {}),
                        ...
                        (m[t] = m[this.p] = this),
                        (this.format = e.formatter || xt(e.defaultValue, e.color, e.collapsible, e.multi)),
                ...
                function Mt(t, e, i, r, n, s) {
                    ...
                    x && ((y = x.xOrigin), (v = x.yOrigin)),
                        (!r || (a = r.split(" ")).length < 2) &&
                            ...
                            (a = [(-1 !== (e = mt(e).split(" "))[0].indexOf("%") ? (parseFloat(e[0]) / 100) * f.width : parseFloat(e[0])) + f.x, (-1 !== e[1].indexOf("%") ? (parseFloat(e[1]) / 100) * f.height : parseFloat(e[1])) + f.y])),
                        ...
                        r &&
                            ...
                            (d = T[4]),
                            (m = T[5]),
                            (g = _ * p - f * c) && ((o = h * (p / g) + u * (-c / g) + (c * m - p * d) / g), (l = h * (-f / g) + u * (_ / g) - (_ * m - f * d) / g), (h = i.xOrigin = a[0] = o), (u = i.yOrigin = a[1] = l))),
                        x &&
                            (s && ((i.xOffset = x.xOffset), (i.yOffset = x.yOffset), (x = i)),
                            n || (!1 !== n && !1 !== B.defaultSmoothOrigin) ? ((o = h - y), (l = u - v), (x.xOffset += o * T[0] + l * T[2] - o), (x.yOffset += o * T[1] + l * T[3] - l)) : (x.xOffset = x.yOffset = 0)),
                ...
                function Dt(t) {
                    ...
                    if (f) {
                        ...
                        if (
                            (null != r.ox && ((v += (c = (r.oxp ? d * r.ox * 0.01 : r.ox) - d / 2) - (c * o + (p = (r.oyp ? m * r.oy * 0.01 : r.oy) - m / 2) * l)), (x += p - (c * h + p * u))),
                            g ? (y += ", Dx=" + ((c = d / 2) - (c * o + (p = m / 2) * l) + v) + ", Dy=" + (p - (c * h + p * u) + x) + ")") : (y += ", sizingMethod='auto expand')"),
                            -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? (_.filter = e.replace(H, y)) : (_.filter = y + " " + e),
                            (0 !== t && 1 !== t) ||
                                1 != o ||
                                0 !== l ||
                                0 !== h ||
                                ...
                                (-1 === e.indexOf(e.indexOf("Alpha")) && _.removeAttribute("filter")),
                            !g)
                        ) {
                            var T,
                                w,
                            ...
                            for (
                                ...
                                (b =
                                    (i = -1 !== (T = f[(w = dt[Ot])]).indexOf("px") ? parseFloat(T) : ft(this.t, w, parseFloat(T), T.replace(N, "")) || 0) !== r[w]
                                        ? Ot < 2
                                            ? -r.ieOffsetX
                                            : -r.ieOffsetY
                                        : Ot < 2
                                        ? c - r.ieOffsetX
                                        : p - r.ieOffsetY),
                                    (_[w] = (r[w] = Math.round(i - b * (0 === Ot || 2 === Ot ? 1 : P))) + "px");
                        }
                    }
                }
                var Ft,
                    ...
                    qt =
                        ...
                        it.createElementNS &&
                            ...
                            !It &&
                            ((Lt = At("svg", Vt)),
                            (Et = (zt = At("rect", Lt, { width: 100, height: 50, x: 100 })).getBoundingClientRect().width),
                            (zt.style[Bt] = "50% 50%"),
                    ...
                    Wt = function (t) {
                        ...
                        if ((Vt.appendChild(i), i.appendChild(this), (this.style.display = "block"), t))
                            try {
                    ...
                    Zt = function (t, e) {
                        ...
                        if (
                            (jt
                                ? (r = _t(t, Xt, null, !0))
                                : t.currentStyle && (r = (r = t.currentStyle.filter.match(Q)) && 4 === r.length ? [r[0].substr(4), Number(r[2].substr(4)), Number(r[1].substr(4)), r[3].substr(4), h.x || 0, h.y || 0].join(",") : ""),
                            ...
                            jt &&
                                ...
                                ((s = u.display),
                                (u.display = "block"),
                                ((l = t.parentNode) && t.offsetParent) || ((a = 1), (o = t.nextSibling), Vt.appendChild(t)),
                                (i = !(r = _t(t, Xt, null, !0)) || "none" === r || "matrix(1, 0, 0, 1, 0, 0)" === r),
                                s ? (u.display = s) : ee(u, "display"),
                                a && (o ? l.insertBefore(t, o) : l ? l.appendChild(t) : Vt.removeChild(t))),
                            (h.svg || (t.getCTM && Qt(t))) &&
                                (i && -1 !== (u[jt] + "").indexOf("matrix") && ((r = u[jt]), (i = 0)),
                                (n = t.getAttribute("transform")),
                                i && n && ((r = "matrix(" + (n = t.transform.baseVal.consolidate().matrix).a + "," + n.b + "," + n.c + "," + n.d + "," + n.e + "," + n.f + ")"), (i = 0))),
                            i)
                        )
                            return Ht;
                        for (n = (r || "").match(z) || [], Ot = n.length; -1 < --Ot; ) (s = Number(n[Ot])), (n[Ot] = (a = s - (s |= 0)) ? ((1e5 * a + (a < 0 ? -0.5 : 0.5)) | 0) / 1e5 + s : s);
                        ...
                        if (((u.svg = !(!t.getCTM || !Qt(t))), u.svg && (Mt(t, _t(t, Bt, e, !1, "50% 50%") + "", u, t.getAttribute("data-svg-origin")), (Ft = B.useSVGTransformAttr || qt)), (n = Zt(t)) !== Ht)) {
                            if (16 === n.length) {
                                var p,
                                    ...
                                    F = n[11],
                                    L = Math.atan2(S, R);
                                u.zOrigin && ((A = k * (D = -u.zOrigin) - n[12]), (M = C * D - n[13]), (D = R * D + u.zOrigin - n[14])),
                                    (u.rotationX = L * J),
                                    L &&
                                    ...
                                    (L = Math.atan2(-T, R)),
                                    (u.rotationY = L * J),
                                    L && ((d = x * (g = Math.cos(-L)) - C * (y = Math.sin(-L))), (m = T * g - R * y), (C = x * y + C * g), (R = T * y + R * g), (F = w * y + F * g), (v = p = v * g - k * y), (x = d), (T = m)),
                                    (L = Math.atan2(x, v)),
                                    (u.rotation = L * J),
                                    L && ((p = v * (g = Math.cos(L)) + x * (y = Math.sin(L))), (d = b * g + P * y), (m = k * g + C * y), (x = x * g - v * y), (P = P * g - b * y), (C = C * g - k * y), (v = p), (b = d), (k = m)),
                                    u.rotationX && 359.9 < Math.abs(u.rotationX) + Math.abs(u.rotation) && ((u.rotationX = u.rotation = 0), (u.rotationY = 180 - u.rotationY)),
                                    (L = Math.atan2(b, P)),
                                    (u.scaleX = ((1e5 * Math.sqrt(v * v + x * x + T * T) + 0.5) | 0) / 1e5),
                                    (u.scaleY = ((1e5 * Math.sqrt(P * P + S * S) + 0.5) | 0) / 1e5),
                                    (u.scaleZ = ((1e5 * Math.sqrt(k * k + C * C + R * R) + 0.5) | 0) / 1e5),
                                    (v /= u.scaleX),
                                    (b /= u.scaleY),
                                    (x /= u.scaleX),
                                    (P /= u.scaleY),
                                    2e-5 < Math.abs(L) ? ((u.skewX = L * J), (b = 0), "simple" !== u.skewType && (u.scaleY *= 1 / Math.cos(L))) : (u.skewX = 0),
                                    (u.perspective = F ? 1 / (F < 0 ? -F : F) : 0),
                                    (u.x = A),
                                    (u.y = M),
                                    (u.z = D),
                                    u.svg && ((u.x -= u.xOrigin - (u.xOrigin * v - u.yOrigin * b)), (u.y -= u.yOrigin - (u.yOrigin * x - u.xOrigin * P)));
                                ...
                                (u.x = n[4] || 0),
                                    ...
                                    (u.rotation = l),
                                    (u.skewX = h),
                                    Yt && ((u.rotationX = u.rotationY = u.z = 0), (u.perspective = c), (u.scaleZ = 1)),
                                    u.svg && ((u.x -= u.xOrigin - (u.xOrigin * E + u.yOrigin * N)), (u.y -= u.yOrigin - (u.xOrigin * I + u.yOrigin * j)));
                            }
                            for (s in (90 < Math.abs(u.skewX) &&
                                Math.abs(u.skewX) < 270 &&
                                (_ ? ((u.scaleX *= -1), (u.skewX += u.rotation <= 0 ? 180 : -180), (u.rotation += u.rotation <= 0 ? 180 : -180)) : ((u.scaleY *= -1), (u.skewX += u.skewX <= 0 ? 180 : -180))),
                            (u.zOrigin = f),
                            u))
                    ...
                    Kt = (st.set3DTransformRatio = st.setTransformRatio = function (t) {
                        var e,
                            ...
                            N = P.skewY,
                            j = P.skewX;
                        if ((N && ((j += N), (O += N)), !((((1 !== t && 0 !== t) || "auto" !== I || (this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime)) && I) || L || E || C || k || 1 !== M) || (Ft && z) || !Yt))
                            O || j || z
                                ? ((O *= K),
                                  (w = j * K),
                                  (b = 1e5),
                                  ...
                                  (r = Math.sin(O - w) * -A),
                                  (a = Math.cos(O - w) * A),
                                  w && "simple" === P.skewType && ((e = Math.tan(w - N * K)), (r *= e = Math.sqrt(1 + e * e)), (a *= e), N && ((e = Math.tan(N * K)), (i *= e = Math.sqrt(1 + e * e)), (s *= e))),
                                  z &&
                                      ((D += P.xOrigin - (P.xOrigin * i + P.yOrigin * r) + P.xOffset),
                                      (F += P.yOrigin - (P.xOrigin * s + P.yOrigin * a) + P.yOffset),
                                      Ft && (P.xPercent || P.yPercent) && ((d = this.t.getBBox()), (D += 0.01 * P.xPercent * d.width), (F += 0.01 * P.yPercent * d.height)),
                                      D < (d = 1e-6) && -d < D && (D = 0),
                                      F < d && -d < F && (F = 0)),
                                  (v = ((i * b) | 0) / b + "," + ((s * b) | 0) / b + "," + ((r * b) | 0) / b + "," + ((a * b) | 0) / b + "," + D + "," + F + ")"),
                                  z && Ft ? this.t.setAttribute("transform", "matrix(" + v) : (S[jt] = (P.xPercent || P.yPercent ? "translate(" + P.xPercent + "%," + P.yPercent + "%) matrix(" : "matrix(") + v))
                                : (S[jt] = (P.xPercent || P.yPercent ? "translate(" + P.xPercent + "%," + P.yPercent + "%) matrix(" : "matrix(") + R + ",0,0," + A + "," + D + "," + F + ")");
                        else {
                            if ((Y && (R < (d = 1e-4) && -d < R && (R = M = 2e-5), A < d && -d < A && (A = M = 2e-5), !E || P.z || P.rotationX || P.rotationY || (E = 0)), O || j))
                                (O *= K),
                                    (m = i = Math.cos(O)),
                                    (g = s = Math.sin(O)),
                                    j &&
                                        ...
                                        (m = Math.cos(O)),
                                        (g = Math.sin(O)),
                                        "simple" === P.skewType && ((e = Math.tan((j - N) * K)), (m *= e = Math.sqrt(1 + e * e)), (g *= e), P.skewY && ((e = Math.tan(N * K)), (i *= e = Math.sqrt(1 + e * e)), (s *= e)))),
                                    (r = -g),
                                    (a = m);
                            else {
                                if (!(C || k || 1 !== M || E || z))
                            ...
                            (u = 1),
                                ...
                                (x = ","),
                                (T = "0"),
                                (O = C * K) && ((m = Math.cos(O)), (_ = c * (l = -(g = Math.sin(O)))), (n = i * g), (o = s * g), (c *= u = m), (i *= m), (s *= m)),
                                (O = k * K) && ((e = r * (m = Math.cos(O)) + n * (g = Math.sin(O))), (y = a * m + o * g), (h = u * g), (f = c * g), (n = r * -g + n * m), (o = a * -g + o * m), (u *= m), (c *= m), (r = e), (a = y)),
                                1 !== M && ((n *= M), (o *= M), (u *= M), (c *= M)),
                                1 !== A && ((r *= A), (a *= A), (h *= A), (f *= A)),
                                1 !== R && ((i *= R), (s *= R), (l *= R), (_ *= R)),
                                (p || z) &&
                                    (p && ((D += n * -p), (F += o * -p), (L += u * -p + p)),
                                    z && ((D += P.xOrigin - (P.xOrigin * i + P.yOrigin * r) + P.xOffset), (F += P.yOrigin - (P.xOrigin * s + P.yOrigin * a) + P.yOffset)),
                                    D < d && -d < D && (D = T),
                                    F < d && -d < F && (F = T),
                                    L < d && -d < L && (L = 0)),
                                (v = P.xPercent || P.yPercent ? "translate(" + P.xPercent + "%," + P.yPercent + "%) matrix3d(" : "matrix3d("),
                                (v += (i < d && -d < i ? T : i) + x + (s < d && -d < s ? T : s) + x + (l < d && -d < l ? T : l)),
                                (v += x + (_ < d && -d < _ ? T : _) + x + (r < d && -d < r ? T : r) + x + (a < d && -d < a ? T : a)),
                                k || C || 1 !== M
                                    ? ((v += x + (h < d && -d < h ? T : h) + x + (f < d && -d < f ? T : f) + x + (n < d && -d < n ? T : n)),
                                      (v += x + (o < d && -d < o ? T : o) + x + (u < d && -d < u ? T : u) + x + (c < d && -d < c ? T : c) + x))
                                    : (v += ",0,0,0,0,1,0,"),
                                (v += D + x + F + x + L + x + (E ? 1 + -L / E : 1) + ")"),
                                (S[jt] = v);
                        }
                    });
                ((t = Gt.prototype).x = t.y = t.z = t.skewX = t.skewY = t.rotation = t.rotationX = t.rotationY = t.zOrigin = t.xPercent = t.yPercent = t.xOffset = t.yOffset = 0),
                    ...
                    Ct(
                        "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",
                        {
                            parser: function (t, e, i, r, n, s, a) {
                                ...
                                if (((b.skewType = x.skewType || b.skewType || B.defaultSkewType), (r._transform = b), "rotationZ" in x && (x.rotation = x.rotationZ), P && "string" == typeof P && jt))
                                    ((h = rt.style)[jt] = P),
                                        (h.display = "block"),
                                        (h.position = "absolute"),
                                        -1 !== P.indexOf("%") && ((h.width = _t(t, "width")), (h.height = _t(t, "height"))),
                                        it.body.appendChild(rt),
                                        (l = $t(rt, null, !1)),
                                        "simple" === b.skewType && (l.scaleY *= Math.cos(l.skewX * K)),
                                        b.svg &&
                                            ((c = b.xOrigin),
                                            (p = b.yOrigin),
                                            (l.x -= b.xOffset),
                                            ...
                                            (x.transformOrigin || x.svgOrigin) &&
                                                ((P = {}), Mt(t, mt(x.transformOrigin), P, x.svgOrigin, x.smoothOrigin, !0), (c = P.xOrigin), (p = P.yOrigin), (l.x -= P.xOffset - b.xOffset), (l.y -= P.yOffset - b.yOffset)),
                                            (c || p) && ((d = Zt(rt, !0)), (l.x -= c - (c * d[0] + p * d[2])), (l.y -= p - (c * d[1] + p * d[3])))),
                                        it.body.removeChild(rt),
                                        l.perspective || (l.perspective = b.perspective),
                                        null != x.xPercent && (l.xPercent = C(x.xPercent, b.xPercent)),
                                        null != x.yPercent && (l.yPercent = C(x.yPercent, b.yPercent));
                                    ...
                                    "string" == typeof x.x && -1 !== x.x.indexOf("%") && ((l.x = 0), (l.xPercent = C(x.x, b.xPercent))),
                                        "string" == typeof x.y && -1 !== x.y.indexOf("%") && ((l.y = 0), (l.yPercent = C(x.y, b.yPercent))),
                                        (l.rotation = R("rotation" in x ? x.rotation : "shortRotation" in x ? x.shortRotation + "_short" : b.rotation, b.rotation, "rotation", T)),
                                        Yt &&
                                            ((l.rotationX = R("rotationX" in x ? x.rotationX : "shortRotationX" in x ? x.shortRotationX + "_short" : b.rotationX || 0, b.rotationX, "rotationX", T)),
                                            (l.rotationY = R("rotationY" in x ? x.rotationY : "shortRotationY" in x ? x.shortRotationY + "_short" : b.rotationY || 0, b.rotationY, "rotationY", T))),
                                        (l.skewX = R(x.skewX, b.skewX)),
                                        (l.skewY = R(x.skewY, b.skewY));
                                }
                                for (
                                    Yt && null != x.force3D && ((b.force3D = x.force3D), (_ = !0)),
                                        (u = b.force3D || b.z || b.rotationX || b.rotationY || l.z || l.rotationX || l.rotationY || l.perspective) || null == x.scale || (l.scaleZ = 1);
                                    -1 < --v;

                                )
                                    (1e-6 < (P = l[(m = Nt[v])] - b[m]) || P < -1e-6 || null != x[m] || null != tt[m]) &&
                                        ((_ = !0), (n = new Pt(b, m, b[m], P, n)), m in T && (n.e = T[m]), (n.xs0 = 0), (n.plugin = s), r._overwriteProps.push(n.n));
                                return (
                                    (P = "function" == typeof x.transformOrigin ? x.transformOrigin(L, F) : x.transformOrigin),
                                    b.svg &&
                                        (P || x.svgOrigin) &&
                                        ((c = b.xOffset),
                                        (p = b.yOffset),
                                        Mt(t, mt(P), l, x.svgOrigin, x.smoothOrigin),
                                        (n = wt(b, "xOrigin", (g ? b : l).xOrigin, l.xOrigin, n, w)),
                                        (n = wt(b, "yOrigin", (g ? b : l).yOrigin, l.yOrigin, n, w)),
                                        (c === b.xOffset && p === b.yOffset) || ((n = wt(b, "xOffset", g ? c : b.xOffset, b.xOffset, n, w)), (n = wt(b, "yOffset", g ? p : b.yOffset, b.yOffset, n, w))),
                                        (P = "0px 0px")),
                                    (P || (Yt && u && b.zOrigin)) &&
                                        (jt
                                            ? ((_ = !0),
                                              (m = Bt),
                                              P || (P = (P = (_t(t, m, S, !1, "50% 50%") + "").split(" "))[0] + " " + P[1] + " " + b.zOrigin + "px"),
                                              (P += ""),
                                              ...
                                              Yt
                                                  ? ((h = b.zOrigin),
                                                    (P = P.split(" ")),
                                                    (b.zOrigin = (2 < P.length ? parseFloat(P[2]) : h) || 0),
                                                    (n.xs0 = n.e = P[0] + " " + (P[1] || "50%") + " 0px"),
                                                    ((n = new Pt(b, "zOrigin", 0, 0, n, -1, n.n)).b = h),
                                                    (n.xs0 = n.e = b.zOrigin))
                                                  : (n.xs0 = n.e = P))
                                            : mt(P + "", b)),
                                    _ && (r._transformType = (b.svg && Ft) || (!u && 3 !== this._transformType) ? 2 : 3),
                                    o && (a.scale = o),
                                    n
                                );
                            },
                    ...
                    Ct("clipPath", { defaultValue: "inset(0%)", prefix: !0, multi: !0, formatter: xt("inset(0% 0% 0% 0%)", !1, !0) }),
                    Ct("borderRadius", {
                        defaultValue: "0px",
                        parser: function (t, e, i, r, n, s) {
                            e = this.format(e);
                            var a,
                                ...
                                b = t.style;
                            for (p = parseFloat(t.offsetWidth), d = parseFloat(t.offsetHeight), a = e.split(" "), o = 0; o < w.length; o++)
                                this.p.indexOf("border") && (w[o] = O(w[o])),
                                    -1 !== (u = h = _t(t, w[o], S, !1, "0px")).indexOf(" ") && ((u = (h = u.split(" "))[0]), (h = h[1])),
                                    (_ = l = a[o]),
                                    (f = parseFloat(u)),
                                    (g = u.substr((f + "").length)),
                                    "" ===
                                        (m = (y = "=" === _.charAt(1))
                                            ? ((c = parseInt(_.charAt(0) + "1", 10)), (_ = _.substr(2)), (c *= parseFloat(_)), _.substr((c + "").length - (c < 0 ? 1 : 0)) || "")
                                            : ((c = parseFloat(_)), _.substr((c + "").length))) && (m = P[i] || g),
                                    m !== g &&
                                        ((v = ft(t, "borderLeft", f, g)),
                                        (x = ft(t, "borderTop", f, g)),
                                        (h = "%" === m ? ((u = (v / p) * 100 + "%"), (x / d) * 100 + "%") : "em" === m ? ((u = v / (T = ft(t, "borderLeft", 1, "em")) + "em"), x / T + "em") : ((u = v + "px"), x + "px")),
                                        y && ((_ = parseFloat(u) + c + m), (l = parseFloat(h) + c + m))),
                    ...
                    Ct("backgroundPosition", {
                        ...
                        parser: function (t, e, i, r, n, s) {
                            ...
                            if ((-1 !== p.indexOf("%")) != (-1 !== d.indexOf("%")) && d.split(",").length < 2 && (_ = _t(t, "backgroundImage").replace(q, "")) && "none" !== _) {
                                for (a = p.split(" "), o = d.split(" "), nt.setAttribute("src", _), l = 2; -1 < --l; )
                                    (h = -1 !== (p = a[l]).indexOf("%")) != (-1 !== o[l].indexOf("%")) &&
                                        ((u = 0 === l ? t.offsetWidth - nt.width : t.offsetHeight - nt.height), (a[l] = h ? (parseFloat(p) / 100) * u + "px" : (parseFloat(p) / u) * 100 + "%"));
                                p = a.join(" ");
                            }
                    ...
                    Ct("margin", { parser: Tt("marginTop,marginRight,marginBottom,marginLeft") }),
                    Ct("padding", { parser: Tt("paddingTop,paddingRight,paddingBottom,paddingLeft") }),
                    Ct("clip", {
                        ...
                        parser: function (t, e, i, r, n, s) {
                            ...
                            return (
                                (e =
                                    D < 9
                                        ? ((o = t.currentStyle), (l = D < 8 ? " " : ","), (a = "rect(" + o.clipTop + l + o.clipRight + l + o.clipBottom + l + o.clipLeft + ")"), this.format(e).split(",").join(l))
                                        : ((a = this.format(_t(t, this.p, S, !1, this.dflt))), this.format(e))),
                    ...
                    Ct("border", {
                        ...
                        parser: function (t, e, i, r, n, s) {
                            var a = _t(t, "borderTopWidth", S, !1, "0px"),
                                ...
                                l = o[0].replace(N, "");
                            return (
                                "px" !== l && (a = parseFloat(a) / ft(t, "borderTopWidth", 1, l) + l),
                                this.parseComplex(t.style, this.format(a + " " + _t(t, "borderTopStyle", S, !1, "solid") + " " + _t(t, "borderTopColor", S, !1, "#000")), o.join(" "), n, s)
                            );
                        },
                        color: !0,
                        formatter: function (t) {
                    ...
                    Ct("borderWidth", { parser: Tt("borderTopWidth,borderRightWidth,borderBottomWidth,borderLeftWidth") }),
                ...
                function Jt(t) {
                    var e,
                        ...
                        n = (this.s + this.c * t) | 0;
                    100 == n && (e = -1 === r.indexOf("atrix(") && -1 === r.indexOf("radient(") && -1 === r.indexOf("oader(") ? (i.removeAttribute("filter"), !_t(this.data, "filter")) : ((i.filter = r.replace(_, "")), !0)),
                        e || (this.xn1 && (i.filter = r = r || "alpha(opacity=" + n + ")"), -1 === r.indexOf("pacity") ? (0 == n && this.xn1) || (i.filter = r + " alpha(opacity=" + n + ")") : (i.filter = r.replace(j, "opacity=" + n)));
                }
                Ct("opacity,alpha,autoAlpha", {
                    ...
                    parser: function (t, e, i, r, n, s) {
                        ...
                        return (
                            ...
                            l && 1 === a && "hidden" === _t(t, "visibility", S) && 0 !== e && (a = 0),
                            ot
                                ? (n = new Pt(o, "opacity", a, e - a, n))
                                : (((n = new Pt(o, "opacity", 100 * a, 100 * (e - a), n)).xn1 = l ? 1 : 0),
                                  (o.zoom = 1),
                                  (n.type = 2),
                                  ...
                                  (n.plugin = s),
                                  (n.setRatio = Jt)),
                            l && (((n = new Pt(o, "visibility", 0, 0, n, -1, null, !1, 0, 0 !== a ? "inherit" : "hidden", 0 === e ? "hidden" : "inherit")).xs0 = "inherit"), r._overwriteProps.push(n.n), r._overwriteProps.push(i)),
                            n
                        );
                    },
                });
                ...
                Ct("className", {
                    parser: function (t, e, i, r, n, s, a) {
                        ...
                        return (
                            ((t._gsClassPT = n).e = "=" !== e.charAt(1) ? e : f.replace(new RegExp("(?:\\s|^)" + e.substr(2) + "(?![\\w-])"), "") + ("+" === e.charAt(0) ? " " + e.substr(2) : "")),
                ...
                function ie(t) {
                    if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                        ...
                        else for (r = (e = this.e.split(" ").join("").split(",")).length; -1 < --r; ) (i = e[r]), m[i] && (m[i].parse === o ? (n = !0) : (i = "transformOrigin" === i ? Bt : m[i].p)), ee(a, i);
                ...
                ((t = B.prototype)._firstPT = t._lastParsedTransform = t._transform = null),
                    (t._onInitTween = function (t, e, i, r) {
                        ...
                        var n,
                            ...
                            c = t.style;
                        if (
                            (w && "" === c.zIndex && (("auto" !== (n = _t(t, "zIndex", S)) && "" !== n) || this._addLazySet(c, "zIndex", 0)),
                            "string" == typeof e && ((o = c.cssText), (n = v(t, S)), (c.cssText = o + ";" + e), (n = x(t, n, v(t)).difs), !ot && G.test(e) && (n.opacity = parseFloat(RegExp.$1)), (e = n), (c.cssText = o)),
                            ...
                            for (
                                f = 3 === this._transformType,
                                    jt
                                        ? b &&
                                          ((w = !0),
                                          "" === c.zIndex && (("auto" !== (u = _t(t, "zIndex", S)) && "" !== u) || this._addLazySet(c, "zIndex", 0)),
                                          M && this._addLazySet(c, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (f ? "visible" : "hidden")))
                                        : (c.zoom = 1),
                                    a = s;
                                a && a._next;
                    ...
                    (t.parse = function (t, e, i, r) {
                        ...
                        for (n in e) {
                            if (((h = e[n]), (s = m[n]), "function" != typeof h || (s && s.allowFunc) || (h = h(L, F)), s)) i = s.parse(t, h, n, this, i, r, e);
                                ...
                                (l = _t(t, n, S) + ""),
                                    (f = "string" == typeof h),
                                    "color" === n || "fill" === n || "stroke" === n || -1 !== n.indexOf("Color") || (f && U.test(h))
                                        ? (f || (h = (3 < (h = yt(h)).length ? "rgba(" : "rgb(") + h.join(",") + ")"), (i = St(p, n, l, h, !0, "transparent", i, 0, r)))
                                        : f && $.test(h)
                                        ? (i = St(p, n, l, h, !0, null, i, 0, r))
                                        : ((u = (a = parseFloat(l)) || 0 === a ? l.substr((a + "").length) : ""),
                                          ("" !== l && "auto" !== l) || (u = "width" === n || "height" === n ? ((a = T(t, n, S)), "px") : "left" === n || "top" === n ? ((a = ct(t, n, S)), "px") : ((a = "opacity" !== n ? 0 : 1), "")),
                                          "" === (_ = (c = f && "=" === h.charAt(1)) ? ((o = parseInt(h.charAt(0) + "1", 10)), (h = h.substr(2)), (o *= parseFloat(h)), h.replace(N, "")) : ((o = parseFloat(h)), f ? h.replace(N, "") : "")) &&
                                              (_ = n in P ? P[n] : u),
                                          ...
                                          u === _ ||
                                              ...
                                              ((a = ft(t, n, a, u)),
                                              "%" === _
                                                  ? ((a /= ft(t, n, 100, "%") / 100), !0 !== e.strictUnits && (l = a + "%"))
                                          ...
                                          c && (o += a),
                                          (!a && 0 !== a) || (!o && 0 !== o)
                                              ? void 0 !== p[n] && (h || (h + "" != "NaN" && null != h))
                                                  ? ((i = new Pt(p, n, o || a || 0, 0, i, -1, n, !1, 0, l, h)).xs0 = "none" !== h || ("display" !== n && -1 === n.indexOf("Style")) ? h : l)
                                                  : g("invalid " + n + " tween value: " + e[n])
                                              : ((i = new Pt(p, n, a, o - a, i, 0, n, !1 !== A && ("px" === _ || "zIndex" === n), 0, l, h)).xs0 = _));
                            }
                ...
                var ne = function (t, e, i) {
                    ...
                    else for (n = (r = t.childNodes).length; -1 < --n; ) (a = (s = r[n]).type), s.style && (e.push(v(s)), i && i.push(s)), (1 !== a && 9 !== a && 11 !== a) || !s.childNodes.length || ne(s, e, i);
                };
                return (
        ...
        ((e = t.prototype)._onInitAllProps = function () {
            ...
            if ("object" != typeof s || s.push) for ("string" == typeof s && (s = s.split(",")), i = s.length; -1 < --i; ) a[s[i]] = Math.round;
                    ...
                    (e = t._next),
                        t.pg
                            ...
                            : t.n === r &&
                              (2 === t.f && t.t
                                  ? h(t.t._firstPT, a[r])
                                  : (this._add(t.t, r, t.s, t.c, a[r]), e && (e._prev = t._prev), t._prev ? (t._prev._next = e) : n._firstPT === t && (n._firstPT = e), (t._next = t._prev = null), (n._propLookup[r] = o))),
                        (t = e);
            return !1;
        }),
            ...
            init: function (t, e, i, r) {
                ...
                for (n in e)
                    "useRadians" !== n &&
                        ...
                        h.length &&
                            (-1 !== (s = h.join("_")).indexOf("short") && (l %= u) !== l % (u / 2) && (l = l < 0 ? l + u : l - u),
                            -1 !== s.indexOf("_cw") && l < 0 ? (l = ((l + 9999999999 * u) % u) - ((l / u) | 0) * u) : -1 !== s.indexOf("ccw") && 0 < l && (l = ((l - 9999999999 * u) % u) - ((l / u) | 0) * u)),
                        (1e-6 < l || l < -1e-6) && (this._addTween(t, n, a, a + l, n), this._overwriteProps.push(n)));
                return !0;
            },
            set: function (t) {
                var e;
                        ...
                        function (t) {
                            for (
                                ...
                                (e = f ? Math.random() : (1 / u) * _),
                                    (i = p ? p.getRatio(e) : e),
                                    (r = "none" === o ? d : "out" === o ? (n = 1 - e) * n * d : "in" === o ? e * e * d : (n = e < 0.5 ? 2 * e : 2 * (1 - e)) * n * 0.5 * d),
                                    f ? (i += Math.random() * r - 0.5 * r) : _ % 2 ? (i += 0.5 * r) : (i -= 0.5 * r),
                                    c && (1 < i ? (i = 1) : i < 0 && (i = 0)),
                                    (l[h++] = { x: e, y: i });
                            for (
                                l.sort(function (t, e) {
    ...
    (function (f, c) {
                    ...
                    if (0 === a && h) {
                        if (((r = (i = ("com.greensock." + o).split(".")).pop()), (n = m(i.join("."))[r] = this.gsClass = h.apply(h, _)), u))
                            if (((d[r] = p[r] = n), "undefined" != typeof module && module.exports))
                                if (o === c) for (s in ((module.exports = p[c] = n), p)) n[s] = p[s];
                                else p[c] && (p[c][r] = n);
                            else
        ...
        for (
            ...
            (n = e[i] + ",Power" + i), u(new S(null, null, 1, i), n, "easeOut", !0), u(new S(null, null, 2, i), n, "easeIn" + (0 === i ? ",easeNone" : "")), u(new S(null, null, 3, i), n, "easeInOut");
        ...
        ((n = k.prototype).addEventListener = function (t, e, i, r, n) {
            ...
            (n.dispatchEvent = function (t) {
                var e,
                    ...
                    r,
                    n = this._listeners[t];
                if (n) for (1 < (e = n.length) && (n = n.slice(0)), i = this._eventTarget; -1 < --e; ) (r = n[e]) && (r.up ? r.c.call(r.s || i, { type: t, target: i }) : r.c.call(r.s || i));
            });
            ...
            var n,
                ...
                c = function (t) {
                    var e,
                        i,
                        r = A() - M;
                    _ < r && (u += r - f), (M += r), (h.time = (M - u) / 1e3), (e = h.time - l), (!n || 0 < e || !0 === t) && (h.frame++, (l += e + (o <= e ? 0.004 : o - e)), (i = !0)), !0 !== t && (a = s(c)), i && h.dispatchEvent("tick");
                };
            k.call(h),
                (h.time = h.frame = 0),
                (h.tick = function () {
                ...
                (h.wake = function (t) {
                    null !== a ? h.sleep() : t ? (u += -M + (M = A())) : 10 < h.frame && (M = A() - _ + 5),
                        (s =
                            0 === n
                                ? g
                                : i && C
        ...
        F(),
            ...
            (n._enabled = function (t, e) {
                return (
                    v || y.wake(), (this._gc = !t), (this._active = this.isActive()), !0 !== e && (t && !this.timeline ? this._timeline.add(this, this._startTime - this._delay) : !t && this.timeline && this._timeline._remove(this, !0)), !1
                );
            }),
        ...
        var E = P(
            ...
            function (t, e, i) {
                ...
                if (((this._overwrite = o = null == o ? Z[E.defaultOverwrite] : "number" == typeof o ? o >> 0 : Z[o]), (a || t instanceof Array || (t.push && T(t))) && "number" != typeof t[0]))
                    for (this._targets = s = l(t), this._propLookup = [], this._siblings = [], r = 0; r < s.length; r++)
                        (n = s[r])
                            ? "string" != typeof n
                                ? n.length && n !== f && n[0] && (n[0] === f || (n[0].nodeType && n[0].style && !n.nodeType))
                                    ? (s.splice(r--, 1), (this._targets = s = s.concat(l(n))))
                                    : ((this._siblings[r] = it(n, this, !1)), 1 === o && 1 < this._siblings[r].length && rt(n, this, null, 1, this._siblings[r]))
                                : "string" == typeof (n = s[r--] = E.selector(n)) && s.splice(r + 1, 1)
                            : s.splice(r--, 1);
        ...
        function X(t, e, i, r, n, s, a, o, l) {
            ...
            var h = typeof t[e],
                ...
                c = { t: t, p: e, s: _, f: "function" == h, pg: 0, n: n || e, m: s ? ("function" == typeof s ? s : Math.round) : 0, pr: 0, c: f ? parseInt(r.charAt(0) + "1", 10) * parseFloat(r.substr(2)) : parseFloat(r) - _ || 0 };
            return (
                ("number" == typeof _ && ("number" == typeof r || f)) ||
                    (a || isNaN(_) || (!f && isNaN(r)) || "boolean" == typeof _ || "boolean" == typeof r
                        ? ((c.fp = a), (c = { t: j(_, f ? parseFloat(c.s) + c.c + (c.s + "").replace(/[0-9\-\.]/g, "") : r, o || E.defaultStringFilter, c), p: "setRatio", s: 0, c: 1, f: 2, pg: 0, n: n || e, pr: 0, m: 0 }))
        ...
        var B = [],
            ...
            G = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
            U = /[\+-]=-?[\.\d]/,
            V = (E._internals = { isArray: T, isSelector: z, lazyTweens: B, blobDif: j }),
            q = (E._plugins = {}),
            W = (V.tweenLookup = {}),
            Q = 0,
            H = (V.reservedProps = {
        ...
        var it = function (t, e, i) {
                var r,
                    n,
                    s = t._gsTweenID;
                if ((W[s || (t._gsTweenID = s = "t" + Q++)] || (W[s] = { target: t, tweens: [] }), e && (((r = W[s].tweens)[(n = r.length)] = e), i))) for (; -1 < --n; ) r[n] === e && r.splice(n, 1);
                return W[s].tweens;
            },
                ...
                for (s = n.length; -1 < --s; )
                    (o = n[s]) === e ||
                        ...
                        (o._timeline !== e._timeline
                            ...
                            : o._startTime <= u && o._startTime + o.totalDuration() / o._timeScale > u && (((c || !o._initted) && u - o._startTime <= 2e-8) || (_[f++] = o)));
                for (s = f; -1 < --s; )
        ...
        (n._init = function () {
            ...
            if (
                ((this._ease = u = u ? (u instanceof S ? u : "function" == typeof u ? new S(u, a.easeParams) : O[u] || E.defaultEase) : E.defaultEase),
            ...
            (n._initProps = function (t, e, i, r, n) {
                ...
                this.vars))
                    if (((u = this.vars[s]), H[s])) u && (u instanceof Array || (u.push && T(u))) && -1 !== u.join("").indexOf("{self}") && (this.vars[s] = u = this._swapSelfInParams(u, this));
                        ...
                        for (this._firstPT = h = { _next: this._firstPT, t: l, p: "setRatio", s: 0, c: 1, f: 1, n: s, pg: 1, pr: l._priority, m: 0 }, a = l._overwriteProps.length; -1 < --a; ) e[l._overwriteProps[a]] = this._firstPT;
                ...
                return r && this._kill(r, t)
                    ...
                    : 1 < this._overwrite && this._firstPT && 1 < i.length && rt(t, this, e, this._overwrite, i)
                    ? (this._kill(e, t), this._initProps(t, e, i, r, n))
                    : (this._firstPT && ((!1 !== this.vars.lazy && this._duration) || (this.vars.lazy && !this._duration)) && (Y[t._gsTweenID] = !0), o);
            }),
            (n.render = function (t, e, i) {
                var r,
                    n,
                ...
                if (h - x <= t && 0 <= t)
                    (o._totalTime = o._time = h),
                        ...
                        0 !== h ||
                            ...
                            (u < 0 || (t <= 0 && -x <= t) || (u === x && "isPause" !== o.data)) && u !== t && ((i = !0), x < u && (n = "onReverseComplete")),
                            (o._rawPrevTime = a = !e || t || u === t ? t : x));
                else if (t < x)
                    (o._totalTime = o._time = 0),
                        (o.ratio = o._ease._calcEnd ? o._ease.getRatio(0) : 0),
                        (0 !== l || (0 === h && 0 < u)) && ((n = "onReverseComplete"), (r = o._reversed)),
                        -x < t ? (t = 0) : t < 0 && ((o._active = !1), 0 !== h || (!o._initted && o.vars.lazy && !i) || (0 <= u && (u !== x || "isPause" !== o.data) && (i = !0), (o._rawPrevTime = a = !e || t || u === t ? t : x))),
                    ...
                    (1 === f || (3 === f && 0.5 <= _)) && (_ = 1 - _),
                        ...
                        (o.ratio = 1 === f ? 1 - _ : 2 === f ? _ : t / h < 0.5 ? _ / 2 : 1 - _ / 2);
                ...
                if (o._time !== l || i) {
                    ...
                    for (
                        !1 !== o._lazy && (o._lazy = !1),
                            o._active || (!o._paused && o._time !== l && 0 <= t && (o._active = !0)),
                            0 === l && (o._startAt && (0 <= t ? o._startAt.render(t, !0, i) : (n = n || "_dummyGS")), !o.vars.onStart || (0 === o._time && 0 !== h) || e || o._callback("onStart")),
                            s = o._firstPT;
                        s;

                    )
                        s.f ? s.t[s.p](s.c * o.ratio + s.s) : (s.t[s.p] = s.c * o.ratio + s.s), (s = s._next);
                    o._onUpdate && (t < 0 && o._startAt && -1e-4 !== t && o._startAt.render(t, !0, i), e || ((o._time !== l || r || i) && o._callback("onUpdate"))),
                        !n ||
                            (o._gc && !i) ||
                            (t < 0 && o._startAt && !o._onUpdate && -1e-4 !== t && o._startAt.render(t, !0, i),
                            r && (o._timeline.autoRemoveChildren && o._enabled(!1, !1), (o._active = !1)),
                            !e && o.vars[n] && o._callback(n),
                            0 === h && o._rawPrevTime === x && a !== x && (o._rawPrevTime = 0));
                }
            }),
            (n._kill = function (t, e, i) {
                ...
                var r,
                    ...
                    c = this._firstPT;
                if ((T(e) || z(e)) && "number" != typeof e[0]) for (r = e.length; -1 < --r; ) this._kill(t, e[r], i) && (l = !0);
                else {
                    if (this._targets) {
            ...
            (n.invalidate = function () {
                ...
                return (
                    ...
                    this.vars.immediateRender && ((this._time = -x), this.render(t, !1, !1 !== this.vars.lazy)),
                    this
                );
            }),
            (n._enabled = function (t, e) {
            ...
            (E.delayedCall = function (t, e, i, r, n) {
                return new E(e, 0, { delay: t, onComplete: e, onCompleteParams: i, callbackScope: r, onReverseComplete: e, onReverseCompleteParams: i, immediateRender: !1, lazy: !1, useFrames: n, overwrite: 0 });
            }),
            (E.set = function (t, e) {
                return new E(t, 0, e);
            }),
        ...
        (void 0 !== LS_GSAP ? LS_GSAP : window).SplitType = (function (C, l, s) {
                      ...
                      (this.elements = (function (t) {
                          ...
                          if (u(t))
                              for (s = 0, r = t.length; s < r; s++)
                                  if (u(t[s])) for (a = 0, n = t[s].length; a < n; a++) _(t[s][a]) && o.push(t[s][a]);
            ...
            if (l.addEventListener && Function.prototype.bind) {
                var a = "splitType" + +new Date(),
                    ...
                    d = { splitClass: "", lineClass: "line", wordClass: "word", charClass: "char", split: "lines, words, chars", position: "relative", absolute: !1, tagName: "div", DEBUG: !1 };
                return (
                    n(r, "defaults", {
                        get: function () {
                            return d;
                            ...
                            R(
                                ...
                                function (t) {
                                    (function (t) {
                                        ...
                                        if (
                                            ((r = h ? M("div") : L()),
                                            (c.innerHTML = t.innerHTML.replace(/<br\s*\/?>/g, " " + o + " ")),
                                            (n = c.textContent
                                                .replace(/\s+/g, " ")
                                                .trim()
                                                .split(" ")
                                                .map(function (t) {
                                                    ...
                                                    if (_) {
                                                        var e = t.split("").map(function (t) {
                                                            return M(a, { class: s.charClass + " " + s.splitClass, style: "display: inline-block;", textContent: t });
                                                        });
                                                        D.apply(d, e);
                                                    }
                                                    return (
                                            ...
                                            (w = A(t).nodes = t.getElementsByTagName(a)),
                                                ...
                                                (O = S.textAlign),
                                                f && ((v = { left: r.offsetLeft, top: r.offsetTop, width: r.offsetWidth }), (T = t.offsetWidth), (x = t.offsetHeight), (A(t).cssWidth = t.style.width), (A(t).cssHeight = t.style.height)),
                                                R(w, function (t) {
                                                    if (t !== r) {
                                                        var e,
                                                            i = t.parentElement === r;
                                                        h && i && ((e = A(t).top = t.offsetTop) !== g && ((g = e), k.push((m = []))), m.push(t)),
                                                            f && ((A(t).top = e || t.offsetTop), (A(t).left = t.offsetLeft), (A(t).width = t.offsetWidth), (A(t).height = y = y || t.offsetHeight));
                                                    }
                                                }),
                                                b.removeChild(t),
                                                h &&
                                                    ...
                                                    (p = k.map(function (t) {
                                                        return (
                                                            r.appendChild((e = M(a, { class: s.lineClass + " " + s.splitClass, style: "display: block; text-align:" + O + "; width: 100%;" }))),
                                                            f && ((A(e).type = "line"), (A(e).top = A(t[0]).top), (A(e).height = y)),
                                                            R(t, function (t) {
                                                                u
                                                                    ? e.appendChild(t)
                                                                    : _
                                                ...
                                                f &&
                                                    ...
                                                    R(w, function (t) {
                                                        ...
                                                        (t.style.top = i ? 0 : A(t).top + "px"),
                                                            (t.style.left = e ? v.left + "px" : (i ? A(t).left - v.left : A(t).left) + "px"),
                                                            (t.style.height = A(t).height + "px"),
                                                            (t.style.width = e ? v.width + "px" : A(t).width + "px"),
        ...
        showNotice: function (t, e, i, r) {
            ...
            o.each(function () {
                (n = jQuery(this)).hasClass(l) ||
                    (n.addClass(l), jQuery('<div class="ls-slider-notification"><i class="ls-slider-notification-logo">!</i><strong>LayerSlider: ' + a + "</strong><span>" + s + "</span></div>").insertBefore(n));
            });
        },
